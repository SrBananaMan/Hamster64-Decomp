...
glabel entrypoint
    /* 1000 80025C00 3C088008 */  lui        $t0, %hi(main_BSS_START)
    /* 1004 80025C04 25089E10 */  addiu      $t0, $t0, %lo(main_BSS_START)
    /* 1008 80025C08 3C09000E */  lui        $t1, %hi(main_BSS_SIZE)
    /* 100C 80025C0C 2529E7F0 */  addiu      $t1, $t1, %lo(main_BSS_SIZE)
  .L80025C10:
    ...
    /* 1028 80025C28 3C0A8002 */  lui        $t2, %hi(main)
    /* 102C 80025C2C 254A5C60 */  addiu      $t2, $t2, %lo(main)
    /* 1030 80025C30 3C1D8012 */  lui        $sp, %hi(D_8011A4F0)
    /* 1034 80025C34 01400008 */  jr         $t2
    /* 1038 80025C38 27BDA4F0 */   addiu     $sp, $sp, %lo(D_8011A4F0)
endlabel entrypoint
